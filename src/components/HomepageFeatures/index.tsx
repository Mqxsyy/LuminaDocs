...
const FeatureList: FeatureItem[] = [
	{
		...
		description: (
			<>
				Allows for a much bigger range of customization and control over
				particles.
			</>
		),
	},
	{
		...
		description: (
			<>A new simple and intuitive way of constructing particle systems.</>
		),
	},
	{
		...
		description: (
			<>
				Built with TypeScript and React, Lumina is a modern and easy-to-use
				particle system.
			</>
		),
	},
